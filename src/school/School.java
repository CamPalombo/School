...
public class School {
    public static void main(String[] args) {
        ...
        Person Joe = Person.addPerson("Joe",Person.Gender.Male,120,1,1,1738);
        Person Jill = Person.addPerson("Jill",Person.Gender.Female,115,1,11,2000);
        Person Fats = Person.addPerson("Fats",Person.Gender.Male,9000000,1,1,2002);
